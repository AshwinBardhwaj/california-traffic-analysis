DROP TABLE collsiontable10K;

CREATE TABLE collisiontable10K(case_id PRIMARY KEY, collision_severity TEXT, latitude REAL, longitude REAL, population TEXT, lighting TEXT, collision_time TEXT, intersection INT, location_type TEXT , 
...
INSERT INTO collisiontable10K select 
     collisions.case_id,
...
where parties.at_fault = 1 AND
	  ...
	  parties.vehicle_year IS NOT NULL AND 
	  ...
	  parties.vehicle_make IS NOT NULL
